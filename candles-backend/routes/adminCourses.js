  ...
  router.post('/', requireAdmin, async (req, res) => {
    try {
      const { title, description, instructor, totalModules, completedModules, thumbnail, videos,pdfUrl } = req.body;
