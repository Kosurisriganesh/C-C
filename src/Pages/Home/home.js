        ...
        <div className="dashboard-container">
            ...
            <div className='Course-cover'>
                ...
                <div className='course-cards'>
                    ...
                    <div className='course-card'>
                        <img src={forex} alt='Commodity Trading' />
                        <div className="course-card-content">
                            <h2> Trading - Futures & Options </h2>
                            <p>Futures and Options (F&O) are financial derivatives that allow traders to bet on the price of an asset without owning it. Futures are agreements to buy or sell at a set price on a future date.
                            Options give the right (but not the obligation) to buy or sell at a set price on or before a certain date.</p>
                            <button><Link to="/login">View Details</Link></button>
                        </div>
                    </div>
                </div>
